...
<mapper namespace="${bgMaple.mapleEntityUpper}Mapper">
	...
	<sql id="${bgMaple.mapleCode}Columns">${bgMaple.mapleCode}Id,${bgMaple.mapleCode ?replace('Detail','')}Id<#list bgMapleDetailList as bgMapleDetail>,${bgMapleDetail.mapleDetailCode}</#list>,orderNum,effective,createUserId,createTime,modifyUserId,modifyTime</sql>
	...
	<include refid="${bgMaple.mapleCode}Columns"/>
			...
			${r"#{"}${bgMaple.mapleCode}Id${r"}"},${r"#{"}${bgMaple.mapleCode ?replace('Detail','')}Id${r"}"}<#list bgMapleDetailList as bgMapleDetail>,${r"#{"}${bgMapleDetail.mapleDetailCode}${r"}"}</#list>,${r"#{orderNum}"},${r"#{effective}"},${r"#{createUserId}"},${r"#{createTime}"},${r"#{modifyUserId}"},${r"#{modifyTime}"}
		)
	</insert>
