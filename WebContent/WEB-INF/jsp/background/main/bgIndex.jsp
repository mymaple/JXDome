...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div>
							<iframe name="mainFrame" id="mainFrame" frameborder="0" src="background/main/tab.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
						</div>
						</div><!-- /.row -->	
					</div><!-- /.page-content -->
		...
		<script type="text/javascript"> 
		var userId = "${bgUser.userId}";			//用户ID
		var userName = "${bgUser.userName}";		//用于即时通讯（ 当前登录用户）
		var onlineManage="${pd.onlineManage}";		//在线管理和站内信服务器IP和端口
		var instantChat="${pd.instantChat}";			//即时聊天服务器IP和端口
		</script>
		<!--引入属于此页面的js -->
